...
public class OCLBuildingsCuboidFinalWithPredicate {
	...
	public static ModelInstanceGraphConfiguration<Cuboid> create_configuration(
		...
		GraphConfigurationPredicate<Cuboid> pred = new GraphConfigurationPredicate<Cuboid>(
				bpu);
		ModelInstanceGraphConfiguration<Cuboid> conf = new GraphConfigurationWithPredicate<Cuboid>(
				bpu, pred, unaryEnergy, binaryEnergy);
		return conf;
	}
