...
public class OCLBuildingsCuboidFinal {
	...
	public ModelInstanceGraphConfiguration<Cuboid> process(BasicPropertyUnit bpu, SimpluParameters p,
		...
		List<Visitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>> list = new ArrayList<Visitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>>();
		if (p.getBoolean("outputstreamvisitor")) {
			Visitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>> visitor = new OutputStreamVisitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>(
					System.out);
			list.add(visitor);
		}
		...
		if (p.getBoolean("csvvisitor")) {
			...
			Visitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>> statsViewer = new CSVvisitor<Cuboid, ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>(
					fileName);
			list.add(statsViewer);
		}
		countV = new CountVisitor<>();
		list.add(countV);
		CompositeVisitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>> mVisitor = new CompositeVisitor<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>(
				list);
	...
	static Sampler<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>> create_sampler(
		...
		Sampler<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>> rs = new RejectionSampler<ModelInstanceGraphConfiguration<Cuboid>, ModelInstanceModification<Cuboid>>(
				s, pred);
		return rs;
	}

	private static EndTest create_end_test(SimpluParameters p) {
	...
	private Schedule<SimpleTemperature> create_schedule(SimpluParameters p) {
		double coefDef = 0;
