 ...
 * @version 1.0
 *
 *          A modification predicate used in a DirectRejectionSampler. When a
 *          modification is proposed, it will first try to apply in it and check
 *          the predicate, then cancel the modification.
 * 
 * @param <O>
 */
public class ModelInstanceGraphConfigurationModificationPredicate<O extends AbstractSimpleBuilding> implements
		ConfigurationModificationPredicate<ModelInstanceGraphConfiguration<O>, ModelInstanceModification<O>> {
	/**
	 * Logger.
	 */
